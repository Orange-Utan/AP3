...
u_linksabs_b = ufloat(np.mean(linksabs_b),np.std(linksabs_b)*2.96)
u_rechtsabs_b = ufloat(np.mean(rechtsabs_b),np.std(rechtsabs_b)*2.96)
u_schirm_b = ufloat(schirm_b,1/2/2/np.sqrt(6)/1000)

u_linksabs_g = ufloat(np.mean(linksabs_g),np.std(linksabs_g)*2.96)
u_rechtsabs_g = ufloat(np.mean(rechtsabs_g),np.std(rechtsabs_g)*2.96)
